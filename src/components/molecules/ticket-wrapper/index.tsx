...
const NoteComponentWrapper = styled.div`
  ...
  .isoNoteListSidebar {
    ...
    border-right: ${(props: any) => (props["data-rtl"] === "rtl" ? 0 : 1)}px
      solid ${palette("border", 0)};
    border-left: ${(props: any) => (props["data-rtl"] === "rtl" ? 1 : 0)}px
      solid ${palette("border", 0)};
...
const NoteListSidebar = styled.div`
  ...
  .ant-input-suffix {
    left: ${(props: any) => (props["data-rtl"] === "rtl" ? "auto" : "10px")};
    right: ${(props: any) => (props["data-rtl"] === "rtl" ? "10px" : "auto")};
    color: ${palette("grayscale", 0)};
  }
  ...
  .isoNoteList {
    ...
    .isoList {
      ...
      .isoDeleteBtn {
        ...
        top: 5px;
        right: ${(props: any) =>
          props["data-rtl"] === "rtl" ? "inherit" : "5px"};
        left: ${(props: any) =>
          props["data-rtl"] === "rtl" ? "5px" : "inherit"};
        padding: 0;
        border: 0;
        font-size: 14px;
        color: ${palette("grayscale", 0)};
